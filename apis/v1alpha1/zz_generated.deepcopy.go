...
func (in *DBShardGroup) DeepCopyInto(out *DBShardGroup) {
	*out = *in
	...
	if in.DBShardGroupARN != nil {
		in, out := &in.DBShardGroupARN, &out.DBShardGroupARN
		*out = new(string)
		**out = **in
	}
...
func (in *ServerlessV2FeaturesSupport) DeepCopy() *ServerlessV2FeaturesSupport {
	...
	out := new(ServerlessV2FeaturesSupport)
	in.DeepCopyInto(out)
	return out
}
