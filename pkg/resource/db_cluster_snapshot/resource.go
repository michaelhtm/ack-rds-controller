...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.DBClusterSnapshotIdentifier = &identifier.NameOrID

	f0, f0ok := identifier.AdditionalKeys["dbClusterIdentifier"]
	if f0ok {
		r.ko.Spec.DBClusterIdentifier = aws.String(f0)
	}
	f2, f2ok := identifier.AdditionalKeys["dbClusterResourceID"]
	if f2ok {
		r.ko.Status.DBClusterResourceID = aws.String(f2)
	}
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f2, f2ok := fields["dbClusterResourceID"]
	if f2ok {
		r.ko.Status.DBClusterResourceID = aws.String(f2)
	}
