...
func (rm *resourceManager) sdkFind(
	...
	for _, elem := range resp.DBInstances {
		...
		if elem.DomainMemberships != nil {
			...
			for _, f36iter := range elem.DomainMemberships {
				...
				if f36iter.DnsIps != nil {
					f36elem.DNSIPs = aws.StringSlice(f36iter.DnsIps)
				}
			...
			ko.Status.DomainMemberships = f36
		} else {
		...
		if elem.IsStorageConfigUpgradeAvailable != nil {
			ko.Status.IsStorageConfigUpgradeAvailable = elem.IsStorageConfigUpgradeAvailable
		} else {
			ko.Status.IsStorageConfigUpgradeAvailable = nil
		}
		...
		if elem.ListenerEndpoint != nil {
			...
			ko.Status.ListenerEndpoint = f50
		} else {
		...
		if elem.OptionGroupMemberships != nil {
			...
			ko.Status.OptionGroupMemberships = f60
		} else {
		...
		if elem.PendingModifiedValues != nil {
			...
			if elem.PendingModifiedValues.AllocatedStorage != nil {
				...
				f61.AllocatedStorage = &allocatedStorageCopy
			}
			if elem.PendingModifiedValues.AutomationMode != "" {
				f61.AutomationMode = aws.String(string(elem.PendingModifiedValues.AutomationMode))
			}
			if elem.PendingModifiedValues.BackupRetentionPeriod != nil {
				...
				f61.BackupRetentionPeriod = &backupRetentionPeriodCopy
			}
			...
			if elem.PendingModifiedValues.PendingCloudwatchLogsExports != nil {
				...
				if elem.PendingModifiedValues.PendingCloudwatchLogsExports.LogTypesToDisable != nil {
					f61f16.LogTypesToDisable = aws.StringSlice(elem.PendingModifiedValues.PendingCloudwatchLogsExports.LogTypesToDisable)
				}
				if elem.PendingModifiedValues.PendingCloudwatchLogsExports.LogTypesToEnable != nil {
					f61f16.LogTypesToEnable = aws.StringSlice(elem.PendingModifiedValues.PendingCloudwatchLogsExports.LogTypesToEnable)
				}
		...
		if elem.VpcSecurityGroups != nil {
			f83 := []*svcapitypes.VPCSecurityGroupMembership{}
			for _, f83iter := range elem.VpcSecurityGroups {
				f83elem := &svcapitypes.VPCSecurityGroupMembership{}
				if f83iter.Status != nil {
					f83elem.Status = f83iter.Status
				}
				if f83iter.VpcSecurityGroupId != nil {
					f83elem.VPCSecurityGroupID = f83iter.VpcSecurityGroupId
				}
				f83 = append(f83, f83elem)
			}
			ko.Status.VPCSecurityGroups = f83
		} else {
...
func (rm *resourceManager) sdkCreate(
	...
	if resp.DBInstance.DBSystemId != nil {
		ko.Spec.DBSystemID = resp.DBInstance.DBSystemId
	} else {
		ko.Spec.DBSystemID = nil
	}
	if resp.DBInstance.DatabaseInsightsMode != "" {
		ko.Status.DatabaseInsightsMode = aws.String(string(resp.DBInstance.DatabaseInsightsMode))
	} else {
		ko.Status.DatabaseInsightsMode = nil
	}
	...
	if resp.DBInstance.DedicatedLogVolume != nil {
		ko.Status.DedicatedLogVolume = resp.DBInstance.DedicatedLogVolume
	} else {
		ko.Status.DedicatedLogVolume = nil
	}
	...
	if resp.DBInstance.EngineLifecycleSupport != nil {
		ko.Spec.EngineLifecycleSupport = resp.DBInstance.EngineLifecycleSupport
	} else {
		ko.Spec.EngineLifecycleSupport = nil
	}
	...
	if resp.DBInstance.IsStorageConfigUpgradeAvailable != nil {
		ko.Status.IsStorageConfigUpgradeAvailable = resp.DBInstance.IsStorageConfigUpgradeAvailable
	} else {
		ko.Status.IsStorageConfigUpgradeAvailable = nil
	}
	...
	if resp.DBInstance.MultiTenant != nil {
		ko.Status.MultiTenant = resp.DBInstance.MultiTenant
	} else {
		ko.Status.MultiTenant = nil
	}
	...
	if resp.DBInstance.PendingModifiedValues != nil {
		...
		if resp.DBInstance.PendingModifiedValues.AutomationMode != "" {
			f61.AutomationMode = aws.String(string(resp.DBInstance.PendingModifiedValues.AutomationMode))
		}
		...
		if resp.DBInstance.PendingModifiedValues.PendingCloudwatchLogsExports != nil {
			...
			if resp.DBInstance.PendingModifiedValues.PendingCloudwatchLogsExports.LogTypesToDisable != nil {
				f61f16.LogTypesToDisable = aws.StringSlice(resp.DBInstance.PendingModifiedValues.PendingCloudwatchLogsExports.LogTypesToDisable)
			}
			if resp.DBInstance.PendingModifiedValues.PendingCloudwatchLogsExports.LogTypesToEnable != nil {
				f61f16.LogTypesToEnable = aws.StringSlice(resp.DBInstance.PendingModifiedValues.PendingCloudwatchLogsExports.LogTypesToEnable)
			}
			f61.PendingCloudwatchLogsExports = f61f16
		}
	...
	if resp.DBInstance.VpcSecurityGroups != nil {
		f83 := []*svcapitypes.VPCSecurityGroupMembership{}
		for _, f83iter := range resp.DBInstance.VpcSecurityGroups {
			f83elem := &svcapitypes.VPCSecurityGroupMembership{}
			if f83iter.Status != nil {
				f83elem.Status = f83iter.Status
			}
...
func (rm *resourceManager) newRestoreDBInstanceFromDBSnapshotInput(
	...
	if r.ko.Spec.ProcessorFeatures != nil {
		resf29 := []svcsdktypes.ProcessorFeature{}
		for _, resf29iter := range r.ko.Spec.ProcessorFeatures {
			resf29elem := &svcsdktypes.ProcessorFeature{}
			if resf29iter.Name != nil {
				resf29elem.Name = resf29iter.Name
			}
...
func (rm *resourceManager) setResourceFromRestoreDBInstanceFromDBSnapshotOutput(
	...
	if resp.DBInstance.DBSystemId != nil {
		r.ko.Spec.DBSystemID = resp.DBInstance.DBSystemId
	} else {
		r.ko.Spec.DBSystemID = nil
	}
	if resp.DBInstance.DatabaseInsightsMode != "" {
		r.ko.Status.DatabaseInsightsMode = aws.String(string(resp.DBInstance.DatabaseInsightsMode))
	} else {
	...
	if resp.DBInstance.DedicatedLogVolume != nil {
		r.ko.Status.DedicatedLogVolume = resp.DBInstance.DedicatedLogVolume
	} else {
		r.ko.Status.DedicatedLogVolume = nil
	}
	if resp.DBInstance.DeletionProtection != nil {
	...
	if resp.DBInstance.DomainMemberships != nil {
		...
		r.ko.Status.DomainMemberships = f36
	} else {
	...
	if resp.DBInstance.EngineLifecycleSupport != nil {
		r.ko.Spec.EngineLifecycleSupport = resp.DBInstance.EngineLifecycleSupport
	} else {
		r.ko.Spec.EngineLifecycleSupport = nil
	}
	if resp.DBInstance.EngineVersion != nil {
	...
	if resp.DBInstance.IsStorageConfigUpgradeAvailable != nil {
		r.ko.Status.IsStorageConfigUpgradeAvailable = resp.DBInstance.IsStorageConfigUpgradeAvailable
	} else {
		r.ko.Status.IsStorageConfigUpgradeAvailable = nil
	}
	if resp.DBInstance.KmsKeyId != nil {
	...
	if resp.DBInstance.ListenerEndpoint != nil {
		...
		r.ko.Status.ListenerEndpoint = f50
	} else {
	...
	if resp.DBInstance.MultiTenant != nil {
		r.ko.Status.MultiTenant = resp.DBInstance.MultiTenant
	} else {
		r.ko.Status.MultiTenant = nil
	}
	if resp.DBInstance.NcharCharacterSetName != nil {
	...
	if resp.DBInstance.OptionGroupMemberships != nil {
		...
		r.ko.Status.OptionGroupMemberships = f60
	} else {
	...
	if resp.DBInstance.PendingModifiedValues != nil {
		...
		r.ko.Status.PendingModifiedValues = f61
	} else {
	...
	if resp.DBInstance.ProcessorFeatures != nil {
		...
		r.ko.Spec.ProcessorFeatures = f67
	} else {
	...
	if resp.DBInstance.VpcSecurityGroups != nil {
		...
		r.ko.Status.VPCSecurityGroups = f83
	} else {
